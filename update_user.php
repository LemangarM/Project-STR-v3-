                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse">
                            ...
                            <span class="icon-bar"></span>
                            <span class="icon-bar"></span>
                            <a href="read_user_template.php"></a>
                        </button>
...
// if the form was submitted
                                if ($_POST) {
                                    ...
                                    try {
                                        ...
                                        if (empty($_POST['login'])) {
                                            echo "<div class='user user-danger'>Oups!!! le champ Login est vide.</div>";
                                ...
                                <form action='update_user.php?id=<?php echo $id; ?>' method='post' id="emailFrm">

                                    <table class='table table-hover table-responsive table-bordered'>

                                        <tr>
                                            <td>Login</td>
                                            <td><input type='text' name='login' value="<?php echo $useradmin->login; ?>" class='form-control' required></td>
                                        </tr>

                                        <tr>
                                            <td>Nom</td>
                                            <td>
                                                <input type='text' name='last_name' value="<?php echo $useradmin->last_name; ?>" class='form-control' required />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Prénom</td>
                                            <td>
                                                <input type='text'  name='first_name' value="<?php echo $useradmin->first_name; ?>" class='form-control' required />
                                            </td>
                                        </tr>
										<P><b>En cliquant sur valider, le mot de passe sera reinitialisé à : 111111. 
										 	L'utilisateur devra le changer à sa connexion</b></P>
