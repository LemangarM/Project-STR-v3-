            ...
            <div class="col-sm-9 col-sm-offset-3 col-lg-11 col-lg-offset-1 main" style="margin-left: 3.7%; width: 96.3%;">
                <div class="row">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><svg class="glyph stroked sound on"><use xlink:href="#stroked-sound-on"/></svg></li>
                    </ol>
                </div><!--/.row-->
                                    ...
                                    <div class="fixed-table-toolbar">
                                        ...
                                        <div class="columns btn-group pull-right" style="margin-top: -0.5px;">
                                            ...
                                            <a href='create_alert.php' class="btn btn-primary">
                                                <span class="glyphicon glyphicon-plus"></span> Créer une alerte
                                            </a>

                                            <!-- delete alert records -->
                                            <button class="btn btn-primary" id="delete-selected">
                                                <span class="glyphicon glyphicon-remove-circle"></span> Supprimer alerte sélectionnée
                                            </button>
                                        </div>
                                    </div>
...
// display the products if there are any
                                        if ($num > 0) {
                                            ...
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                // edit product button
                                                echo "<a href='update_alert.php?id={$Id}' class='btn btn-primary'>";
