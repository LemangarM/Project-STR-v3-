            ...
            <div class="col-sm-9 col-sm-offset-3 col-lg-11 col-lg-offset-1 main" style="margin-left: 3.7%; width: 96.3%;">
                <div class="row">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg></li>
                    </ol>
                </div><!--/.row-->
                                ...
                                <div class="bootstrap-table">
                                    <div class="fixed-table-toolbar">
                                        ...
                                        <div class="columns btn-group pull-right" style="margin-top: -0.5px;">
                                            ...
                                            <button class="btn btn-primary" id="delete-selected-user">
                                                <span class="glyphicon glyphicon-remove-circle"></span> Supprimer les utilisateurs selectionnés
                                            </button>
                                        </div>
                                    </div>
...
// display the products if there are any
                                        if ($num > 0) {
                                            ...
                                            echo "Login";
                                            echo $field == "login" ? $field_sort_html : "";
                                            echo "</a>";
                                            echo "</th>";
                                            echo "<th>";
                                            //echo "<a href='read_user_sorted_by_fields.php?field=profil&order={$reverse_order}'>";
                                            echo "Profil";
                                            echo $field == "profil" ? $field_sort_html : "";
                                            echo "</a>";
                                            echo "</th>";

                                            echo "<th>";
                                            // echo "<a href='read_user_sorted_by_fields.php?field=last_name&order={$reverse_order}'>";
                                            echo "Nom";
                                            echo $field == "last_name" ? $field_sort_html : "";
                                            echo "</a>";
                                            echo "</th>";
                                            echo "<th>";
                                            //echo "<a href='read_user_sorted_by_fields.php?field=first_name&order={$reverse_order}'>";
                                            echo "Prénom";
                                            echo $field == "first_name" ? $field_sort_html : "";
                                            echo "</a>";
                                            echo "</th>";
                                            ...
                                            echo "Dernière mise à jour d'admin";
                                            echo $field == "date_last_maj" ? $field_sort_html : "";
                                            echo "</a>";
                                            echo "</th>";
                                            //   echo "<th>";
                                            ...
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                // edit product button
                                                echo "<a href='update_user.php?id={$id}' class='btn btn-primary'>";
