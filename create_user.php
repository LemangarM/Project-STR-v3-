...
if ($_SESSION['connect'] == 1 && $_SESSION['first_login'] == 0 && $_SESSION['admin'] == 'admin') {
    ?>
    <?php
    ...
    <html>
        <head>
            ...
            <title>Stormonitoring - Ajouter un utilisateur</title>
            ...
            <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar" style="width: 50px">
                <ul class="nav menu">
                    ...
                    <?php if ($_SESSION['admin'] == 'admin') : ?>
                        <li class="active" title="Gestion des utilisateurs"><a href="read_user.php"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg></a></li>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-lg-11 col-lg-offset-1 main" style="margin-left: 3.7%; width: 96.3%;">
                <div class="row">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="read_user.php"><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg></a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                echo "<a href='read_user.php' class='btn btn-primary pull-right'>";
                                echo "<span class='glyphicon glyphicon-list'></span> Liste des utilisateurs";
                                echo "</a>";
                                echo "</div>";
                                ...
                                if ($_POST) {
                                    ...
                                    try {
                                        ...
                                        if (empty($_POST['login'])) {
                                            echo "<div class='alert alert-danger'>Oups!!! le champ Login est vide.</div>";
                                            ...
                                            echo "<div class='alert alert-danger'>Oups!!! le champ Nom est vide.</div>";
                                        ...
                                        $useradmin->login = filter_input(INPUT_POST, 'login');
                                        $useradmin->last_name = filter_input(INPUT_POST, 'last_name');
                                ...
                                <form action='create_user.php' method='post' id="userFrm">
                                    <table class='table table-hover table-responsive table-bordered'>
                                        <tr>
                                            <td>Login</td>
                                            <td><input type='text' name='login' class='form-control' value="<?php echo isset($_POST['login']) ? htmlspecialchars($_POST['login'], ENT_QUOTES) : ""; ?>"></td>
                                        </tr>
										
										<tr>
                                            <td>Nom</td>
                                            <td><input type='text' name='first_name' class='form-control' value="<?php echo isset($_POST['first_name']) ? htmlspecialchars($_POST['first_name'], ENT_QUOTES) : ""; ?>"></td>
                                        </tr>
										
                                        <tr>
                                            <td>Prénom</td>
                                            <td><input type='text' name='last_name' class='form-control' value="<?php echo isset($_POST['last_name']) ? htmlspecialchars($_POST['last_name'], ENT_QUOTES) : ""; ?>"></td>
                                        </tr>

                                       

                                        <tr>
                                        <P><b>Le mot de passe par défaut est : 111111. 
                                                L'utilisateur devra le changer à sa première connexion</b></P>
    <!--  <td><input type='text' name='password' class='form-control' value="<?php echo isset($_POST['password']) ? htmlspecialchars($_POST['password'], ENT_QUOTES) : ""; ?>"></td> -->
                                        </tr>
    ...
    ?>
                                ...
                                <?php
                            } elseif ($_SESSION['connect'] == 1 && $_SESSION['first_login'] == 1 && $_SESSION['admin'] !== 'admin') { // Le mot de passe n'est pas bon.
